...
const PaymentSummary = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={[styles.cardTitle,{fontSize:15}]}>Scan the QR to Proceed with the Payment</Text>
        {/* QR Code Placeholder */}
        ...
        <Text style={styles.cardContent}>Account Number: 3940002100057010</Text>
        <Text style={styles.cardContent}>IFSC Code: PUNB03940000</Text>
        <Text style={styles.cardContent}>Bank Name: Punjab National Bank</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.checkboxContainer}>
          ...
          />
          <Text style={styles.checkboxLabel}>Request for Sample (optional)</Text>
        </View>
      </View>

     <View style={styles.card}>
     <Text style={{fontSize:13,fontWeight:"bold"}}>Send the Payment Transaction Details to this Mail</Text>
     <Text style={styles.supportEmail}>Support @b2bhubindia.com</Text>
      ...
      <View style={styles.deliveryDetails}>
        ...
        <Pressable onPress={()=> nav.navigate('Sucessfull')} style={{backgroundColor:"#4870F4",padding:8,justifyContent:"center",borderRadius:15,margin:5,width:"100%"}}>
          <Text style={{color:"white",textAlign:"center"}}>Pre Book Order</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
